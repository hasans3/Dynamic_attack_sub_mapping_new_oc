...
This method uses new open command using DSS TEXT 
"""
...
#        print new_outage_list
    ...
    worst_case_subs = obtain_subs.maptest14bus_test_system(comp_filename, start_range, contingency_range, worst_case_outage)
...
#greedy_hueristics("'G:\saqib\open DSS\OpenDSS_Python_Interface\ieee39bus_system\ieee39bus_system_with_1kv_base_testing.dss'", "G:\saqib\open DSS\OpenDSS_Python_Interface\ieee39bus_system\component_data_subs.txt", "G:\saqib\open DSS\OpenDSS_Python_Interface\ieee39bus_system\Load_data1_testing.txt", 0, 1, 40, 'ieee39bus_system_test_N-3.xml', 2);
